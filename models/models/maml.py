...
from models.common.modules import Module, BatchNorm2d, get_child_dict


@Registers.model.register
class MAML(Module):
    def __init__(self, encoder, classifier, encoder_args, classifier_args):
        super(MAML, self).__init__()
        self.encoder = Registers.module[encoder](encoder_args)
        classifier_args['in_dim'] = self.encoder.get_out_dim()
        self.classifier = Registers.module[classifier](**classifier_args)
