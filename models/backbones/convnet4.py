...
from models.common.modules import Module, Sequential, Conv2d, BatchNorm2d, get_child_dict
...
def convnet4(encoder_args=dict()):
  return ConvNet4(32, 32, encoder_args.get("bn", dict()))
